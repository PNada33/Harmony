package xd.harm.modules.models.freddy;
...
public class FreddyModel implements IMinecraft {

    private static final ResourceLocation MODEL_LOCATION = new ResourceLocation("minecraft", "harmony/models/pet/freddy_mesh.json");
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("minecraft", "harmony/images/pet/freddy.png");
    ...
    public void render(MatrixStack matrixStack, EventRender3D event, FreddyBrain brain) {
        ensureLoaded();
    ...
    private void ensureLoaded() {
        ...
        try (InputStream stream = Minecraft.getInstance().getResourceManager().getResource(MODEL_LOCATION).getInputStream();
            ...
            failed = true;
            System.err.println("Failed to load freddy pet model from " + MODEL_LOCATION);
            e.printStackTrace();
        }
    }
