package xd.harm.modules.models.spike;
...
public class SpikeModel implements IMinecraft {

    private static final ResourceLocation MODEL_LOCATION = new ResourceLocation("minecraft", "harmony/models/pet/spike_mesh.json");
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("minecraft", "harmony/images/pet/spike.png");
    ...
    public void render(MatrixStack matrixStack, EventRender3D event, SpikeBrain brain) {
        ensureLoaded();
    ...
    private void ensureLoaded() {
        ...
        try (InputStream stream = Minecraft.getInstance().getResourceManager().getResource(MODEL_LOCATION).getInputStream();
            ...
            failed = true;
            System.err.println("Failed to load spike pet model from " + MODEL_LOCATION);
            e.printStackTrace();
        }
    }
