...
public class KeyStorage {
    ...
    public static String getKey(int integer) {
        ...
        String mapped = KeyStorage.getReverseKey(integer);
        if (mapped != null && !mapped.isEmpty()) {
            return mapped;
        }

        String glfwName = GLFW.glfwGetKeyName(integer, -1);
        if (glfwName != null && !glfwName.isEmpty()) {
            return glfwName.toUpperCase(Locale.ROOT);
        }

        return integer == GLFW.GLFW_KEY_UNKNOWN ? "" : "KEY" + integer;
    }
    ...
    public static Integer getKey(String key) {
        ...
        return keyMap.get(normalizeKeyName(key));
    }
    ...
    private static void putMappings() {
        ...
        keyMap.put("NUMPAD0", GLFW.GLFW_KEY_KP_0);
        ...
        keyMap.put("PGDN", GLFW.GLFW_KEY_PAGE_DOWN);
        ...
        keyMap.put("SHIFT", GLFW.GLFW_KEY_LEFT_SHIFT);
        keyMap.put("RIGHT_CONTROL", GLFW.GLFW_KEY_RIGHT_CONTROL);
        keyMap.put("RIGHT_CTRL", GLFW.GLFW_KEY_RIGHT_CONTROL);
        ...
        keyMap.put("CTRL", GLFW.GLFW_KEY_LEFT_CONTROL);
        keyMap.put("CONTROL", GLFW.GLFW_KEY_LEFT_CONTROL);
        ...
        keyMap.put("ALT", GLFW.GLFW_KEY_LEFT_ALT);
    ...
    private static void reverseMappings() {
        ...
        reverseKeyMap.put(GLFW.GLFW_KEY_KP_0, "NUMPAD0");
        reverseKeyMap.put(GLFW.GLFW_KEY_PAGE_UP, "PAGEUP");
        reverseKeyMap.put(GLFW.GLFW_KEY_PAGE_DOWN, "PAGEDOWN");
        reverseKeyMap.put(GLFW.GLFW_KEY_LEFT_SHIFT, "LEFT_SHIFT");
        reverseKeyMap.put(GLFW.GLFW_KEY_RIGHT_SHIFT, "RIGHT_SHIFT");
        reverseKeyMap.put(GLFW.GLFW_KEY_LEFT_CONTROL, "LEFT_CONTROL");
        reverseKeyMap.put(GLFW.GLFW_KEY_RIGHT_CONTROL, "RIGHT_CONTROL");
        reverseKeyMap.put(GLFW.GLFW_KEY_LEFT_ALT, "LEFT_ALT");
        reverseKeyMap.put(GLFW.GLFW_KEY_RIGHT_ALT, "RIGHT_ALT");
    }
}
