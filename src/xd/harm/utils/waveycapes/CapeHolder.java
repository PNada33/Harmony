...
import xd.harm.utils.waveycapes.math.Vector2;
...
public interface CapeHolder {
    ...
    default void updateSimulation(AbstractClientPlayerEntity abstractClientPlayer, int partCount) {
        ...
        if (dirty) {
            ...
            for (int i = 0; i < 5; ++i) {
                holder.simulate(abstractClientPlayer);
            }
        }
    }
    ...
    default void simulate(AbstractClientPlayerEntity abstractClientPlayer) {
        ...
        final float straveMul = (float) WaveyCapesBase.config.strafeMultiplier;
