...
public class SliderComponent {
    ...
    public void draw(MatrixStack stack, float mouseX, float mouseY) {
        ...
        fieldComponent.setX(x + Fonts.sfuy.getWidth(name, 6) + 5);
        ...
        RenderUtility.drawRoundedRect(x,y + 7,width,height - 7, 1, ColorUtils.rgba(27, 27, 27, 255));
        RenderUtility.drawRoundedRect(x,y + 7,widthSlider,height - 7, 1, ColorUtils.getColor(0));
