...
public abstract class AnimationUtility {
    ...
    public AnimationUtility(int ms, double endPoint) {
        this.duration = ms;
    ...
    public AnimationUtility(int ms, double endPoint, Direction direction) {
        this.duration = ms;
        this.endPoint = endPoint;
