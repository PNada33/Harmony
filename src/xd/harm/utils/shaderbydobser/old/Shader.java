...
public class Shader {
    ...
    public Shader(String path) {
        init(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("Harmony/shader/impl/" + path + ".frag")).getInputStream()));
    }
    ...
    private void init(String source) {
        ...
        ARBShaderObjects.glAttachObjectARB(program, createShader(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("Harmony/shader/vertex.vert")).getInputStream()), GL_VERTEX_SHADER));
    ...
    public void drawQuads(final float x,
        ...
        RenderUtility.quadsBegin(x, y, width, height, GL_POLYGON);
    }
