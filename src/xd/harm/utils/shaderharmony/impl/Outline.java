package xd.harm.utils.shaderharmony.impl;
...
public class Outline implements IMinecraft {
    ...
    private static void initUniforms() {
        ...
        sizeUniform = ShaderUtility.outline.getUniform("size");
        textureInUniform = ShaderUtility.outline.getUniform("textureIn");
        textureToCheckUniform = ShaderUtility.outline.getUniform("textureToCheck");
        texelSizeUniform = ShaderUtility.outline.getUniform("texelSize");
        directionUniform = ShaderUtility.outline.getUniform("direction");
        colorUniform = ShaderUtility.outline.getUniform("color");
