...
public class StrafeMovement implements IMinecraft {
    ...
    public double calculateSpeed(final MovingEvent move, boolean damageBoost, boolean hasTime, boolean autoJump, float damageSpeed) {
    ...
    private float getFrictionFactor(final ClientPlayerEntity contextPlayer, final MovingEvent move) {
