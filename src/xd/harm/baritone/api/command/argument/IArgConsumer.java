...
package xd.harm.baritone.api.command.argument;

import xd.harm.baritone.api.command.ICommand;
import xd.harm.baritone.api.command.argparser.IArgParser;
import xd.harm.baritone.api.command.datatypes.IDatatype;
import xd.harm.baritone.api.command.datatypes.IDatatypeFor;
import xd.harm.baritone.api.command.datatypes.IDatatypePost;
import xd.harm.baritone.api.command.exception.CommandException;
import xd.harm.baritone.api.command.exception.CommandInvalidTypeException;
import xd.harm.baritone.api.command.exception.CommandNotEnoughArgumentsException;
import xd.harm.baritone.api.command.exception.CommandTooManyArgumentsException;
 ...
 * data in variables BEFORE logging any data to chat xd.harm.viaversion {@link Helper#logDirect(String)}, so that the error
