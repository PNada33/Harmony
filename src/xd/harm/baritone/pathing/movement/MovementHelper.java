...
package xd.harm.baritone.pathing.movement;
...
import xd.harm.baritone.pathing.movement.MovementState.MovementTarget;
import xd.harm.baritone.pathing.precompute.Ternary;
import xd.harm.baritone.utils.BlockStateInterface;
import xd.harm.baritone.utils.ToolSet;
...
import static xd.harm.baritone.pathing.movement.Movement.HORIZONTALS_BUT_ALSO_DOWN_____SO_EVERY_DIRECTION_EXCEPT_UP;
import static xd.harm.baritone.pathing.precompute.Ternary.*;
    ...
    static void moveTowards(IPlayerContext ctx, MovementState state, BlockPos pos) {
        state.setTarget(new MovementTarget(
                new Rotation(RotationUtils.calcRotationFromVec3d(ctx.playerHead(),
                        ...
                        ctx.playerRotations()).getYaw(), ctx.player().rotationPitchHead),
                false
