...
default IVertexBuilder color(float red, float green, float blue, float alpha)
    ...
    default IVertexBuilder color1(int color)
    {


        return this.color((int)(ColorUtils.rgb(255,255,255) * 255.0F), (int)(ColorUtils.rgb(255,255,255) * 255.0F), (int)(ColorUtils.rgb(255,255,255) * 255.0F), (int)(ColorUtils.rgb(255,255,255) * 255.0F));
    }
