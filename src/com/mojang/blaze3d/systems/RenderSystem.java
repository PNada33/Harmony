...
public class RenderSystem
{
    ...
    private static final boolean CHECK_THREAD_ACCESS = Boolean.getBoolean("harmony.render.threadChecks");
    ...
    private static final MatrixStack MODEL_VIEW_STACK = new MatrixStack();
    ...
    {
        if (CHECK_THREAD_ACCESS && !p_assertThread_0_.get())
        {
    ...
    public static void replayQueue()
    {
        ...
        try
        {
            IRenderCall irendercall;

            while ((irendercall = recordingQueue.poll()) != null)
            {
                irendercall.execute();
            }
        }
