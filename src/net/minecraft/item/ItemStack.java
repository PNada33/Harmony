...
public final class ItemStack implements IItemStack {
    ...
    private boolean isHeldByMainHand = false;
    private boolean isHeldByOffHand = false;
    ...
    public ItemStack copy() {
        if (this.isEmpty()) {
            ...
            itemstack.setHeldByMainHand(this.isHeldByMainHand);
            itemstack.setHeldByOffHand(this.isHeldByOffHand);
    ...
    public List<ITextComponent> getTooltip(@Nullable PlayerEntity playerIn, ITooltipFlag advanced) {
        ...
        if (func_242394_a(i, TooltipDisplayFlags.ADDITIONAL)) {
            this.getItem().addInformation(this, playerIn == null ? null : playerIn.world, list, advanced);
        }

        if (this.hasTag()) {
            if (func_242394_a(i, TooltipDisplayFlags.ENCHANTMENTS)) {
            ...
            if (this.tag.contains("display", 10)) {
                ...
                if (func_242394_a(i, TooltipDisplayFlags.DYE) && compoundnbt.contains("color", 99)) {
        ...
        if (func_242394_a(i, TooltipDisplayFlags.MODIFIERS)) {
        ...
        if (this.hasTag()) {
            if (func_242394_a(i, TooltipDisplayFlags.UNBREAKABLE) && this.tag.getBoolean("Unbreakable")) {
                list.add((new TranslationTextComponent("item.unbreakable")).mergeStyle(TextFormatting.BLUE));
            }

            if (func_242394_a(i, TooltipDisplayFlags.CAN_DESTROY) && this.tag.contains("CanDestroy", 9)) {
            ...
            if (func_242394_a(i, TooltipDisplayFlags.CAN_PLACE) && this.tag.contains("CanPlaceOn", 9)) {
    ...
    public boolean isHeldByMainHand() {
        return this.isHeldByMainHand;
    }

    public void setHeldByMainHand(boolean isHeldByMainHand) {
        this.isHeldByMainHand = isHeldByMainHand;
    }

    public boolean isHeldByOffHand() {
        return this.isHeldByOffHand;
    }

    public void setHeldByOffHand(boolean isHeldByOffHand) {
        this.isHeldByOffHand = isHeldByOffHand;
    }
