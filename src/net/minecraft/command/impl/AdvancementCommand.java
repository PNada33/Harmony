...
public class AdvancementCommand
{
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher)
    {
        ...
        {
            return forEachAdvancement(p_198202_0_.getSource(), EntityArgument.getPlayers(p_198202_0_, "targets"), Action.GRANT, getMatchingAdvancements(ResourceLocationArgument.getAdvancement(p_198202_0_, "advancement"), Mode.ONLY));
        ...
        {
            return updateCriterion(p_198212_0_.getSource(), EntityArgument.getPlayers(p_198212_0_, "targets"), Action.GRANT, ResourceLocationArgument.getAdvancement(p_198212_0_, "advancement"), StringArgumentType.getString(p_198212_0_, "criterion"));
        ...
        {
            return forEachAdvancement(p_198215_0_.getSource(), EntityArgument.getPlayers(p_198215_0_, "targets"), Action.GRANT, getMatchingAdvancements(ResourceLocationArgument.getAdvancement(p_198215_0_, "advancement"), Mode.FROM));
        ...
        {
            return forEachAdvancement(p_198204_0_.getSource(), EntityArgument.getPlayers(p_198204_0_, "targets"), Action.GRANT, getMatchingAdvancements(ResourceLocationArgument.getAdvancement(p_198204_0_, "advancement"), Mode.UNTIL));
        ...
        {
            return forEachAdvancement(p_198211_0_.getSource(), EntityArgument.getPlayers(p_198211_0_, "targets"), Action.GRANT, getMatchingAdvancements(ResourceLocationArgument.getAdvancement(p_198211_0_, "advancement"), Mode.THROUGH));
        }))).then(Commands.literal("everything").executes((p_198217_0_) ->
        {
            return forEachAdvancement(p_198217_0_.getSource(), EntityArgument.getPlayers(p_198217_0_, "targets"), Action.GRANT, p_198217_0_.getSource().getServer().getAdvancementManager().getAllAdvancements());
        ...
        {
            return forEachAdvancement(p_198198_0_.getSource(), EntityArgument.getPlayers(p_198198_0_, "targets"), Action.REVOKE, getMatchingAdvancements(ResourceLocationArgument.getAdvancement(p_198198_0_, "advancement"), Mode.ONLY));
        ...
        {
            return updateCriterion(p_198200_0_.getSource(), EntityArgument.getPlayers(p_198200_0_, "targets"), Action.REVOKE, ResourceLocationArgument.getAdvancement(p_198200_0_, "advancement"), StringArgumentType.getString(p_198200_0_, "criterion"));
        ...
        {
            return forEachAdvancement(p_198208_0_.getSource(), EntityArgument.getPlayers(p_198208_0_, "targets"), Action.REVOKE, getMatchingAdvancements(ResourceLocationArgument.getAdvancement(p_198208_0_, "advancement"), Mode.FROM));
        ...
        {
            return forEachAdvancement(p_198201_0_.getSource(), EntityArgument.getPlayers(p_198201_0_, "targets"), Action.REVOKE, getMatchingAdvancements(ResourceLocationArgument.getAdvancement(p_198201_0_, "advancement"), Mode.UNTIL));
        ...
        {
            return forEachAdvancement(p_198197_0_.getSource(), EntityArgument.getPlayers(p_198197_0_, "targets"), Action.REVOKE, getMatchingAdvancements(ResourceLocationArgument.getAdvancement(p_198197_0_, "advancement"), Mode.THROUGH));
        }))).then(Commands.literal("everything").executes((p_198213_0_) ->
        {
            return forEachAdvancement(p_198213_0_.getSource(), EntityArgument.getPlayers(p_198213_0_, "targets"), Action.REVOKE, p_198213_0_.getSource().getServer().getAdvancementManager().getAllAdvancements());
        })))));
    }
