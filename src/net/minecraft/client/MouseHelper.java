...
public class MouseHelper {
        ...
        if (handle == this.minecraft.getMainWindow().getHandle()) {
            ...
            if (this.minecraft.loadingGui == null) {
                if (this.minecraft.currentScreen == null) {
                    ...
                    double d0 = HarmonyGuiScale.getScaledMouseX(this.minecraft, this.minecraft.currentScreen, this.mouseX);
                    double d1 = HarmonyGuiScale.getScaledMouseY(this.minecraft, this.minecraft.currentScreen, this.mouseY);
            ...
            if (!aboolean[0] && (this.minecraft.currentScreen == null || this.minecraft.currentScreen.passEvents)
                ...
                if (flag) {
                    Harmony.getInstance().onKeyPressed(-100 + i);

                    eventMouseButtonPress.setButton(i);
                    Harmony.getInstance().getEventBus().post(eventMouseButtonPress);
    ...
    private void scrollCallback(long handle, double xoffset, double yoffset) {
        if (handle == Minecraft.getInstance().getMainWindow().getHandle()) {
            ...
            if (this.minecraft.loadingGui == null) {
                if (this.minecraft.currentScreen != null) {
                    double d1 = HarmonyGuiScale.getScaledMouseX(this.minecraft, this.minecraft.currentScreen, this.mouseX);
                    double d2 = HarmonyGuiScale.getScaledMouseY(this.minecraft, this.minecraft.currentScreen, this.mouseY);
    ...
    private void cursorPosCallback(long handle, double xpos, double ypos) {
        if (handle == Minecraft.getInstance().getMainWindow().getHandle()) {
            ...
            if (iguieventlistener != null && this.minecraft.loadingGui == null) {
                double d0 = HarmonyGuiScale.getScaledMouseX(this.minecraft, this.minecraft.currentScreen, xpos);
                double d1 = HarmonyGuiScale.getScaledMouseY(this.minecraft, this.minecraft.currentScreen, ypos);
                Screen.wrapScreenError(() -> {
                ...
                if (this.activeButton != -1 && this.eventTime > 0.0D) {
                    double d2 = HarmonyGuiScale.getScaledMouseDeltaX(this.minecraft, this.minecraft.currentScreen,
                            xpos - this.mouseX);
                    double d3 = HarmonyGuiScale.getScaledMouseDeltaY(this.minecraft, this.minecraft.currentScreen,
                            ypos - this.mouseY);
                    Screen.wrapScreenError(() -> {
    ...
    public void updatePlayerLook() {
        ...
        if (this.isMouseGrabbed() && this.minecraft.isGameFocused()) {
            ...
            if (this.minecraft.player != null) {
                ...
                Harmony.getInstance().getEventBus().post(eventRotate);
