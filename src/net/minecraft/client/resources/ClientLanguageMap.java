...
public class ClientLanguageMap extends LanguageMap
{
    ...
    public static ClientLanguageMap func_239497_a_(IResourceManager p_239497_0_, List<Language> p_239497_1_)
    {
        ...
        for (Language language : p_239497_1_)
        {
            ...
            try
            {
                ResourceLocation voiceChatLang = new ResourceLocation("voicechat/lang/" + langCode + ".json");
                func_239498_a_(p_239497_0_.getAllResources(voiceChatLang), map);
            }
            catch (FileNotFoundException filenotfoundexception)
            {
            }
            ...
            {
                field_239493_a_.warn("Skipped voicechat language file: voicechat:lang/{}.json ({})", langCode, exception.toString());
            }
        }
