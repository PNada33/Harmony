...
public class BossOverlayGui extends AbstractGui {
    ...
    public final Map<UUID, ClientBossInfo> mapBossInfos = Maps.newLinkedHashMap();
        ...
        if (!this.mapBossInfos.isEmpty()) {
            ...
            for (ClientBossInfo clientbossinfo : this.mapBossInfos.values()) {
                ...
                if (Reflector.ForgeHooksClient_bossBarRenderPre.exists()) {
                    Object object = Reflector.ForgeHooksClient_bossBarRenderPre.call(p_238484_1_,
                            this.client.getMainWindow(), clientbossinfo, k, j, 10 + 9);
    ...
    private void func_238485_a_(MatrixStack p_238485_1_, int p_238485_2_, int p_238485_3_, BossInfo p_238485_4_) {
        ...
        if (p_238485_4_.getOverlay() != BossInfo.Overlay.PROGRESS) {
            this.blit(p_238485_1_, p_238485_2_, p_238485_3_, 0, 80 + (p_238485_4_.getOverlay().ordinal() - 1) * 5 * 2,
                    182, 5);
        }
        ...
        if (i > 0) {
            ...
            if (p_238485_4_.getOverlay() != BossInfo.Overlay.PROGRESS) {
                this.blit(p_238485_1_, p_238485_2_, p_238485_3_, 0,
                        80 + (p_238485_4_.getOverlay().ordinal() - 1) * 5 * 2 + 5, i, 5);
            }
        }
    }
