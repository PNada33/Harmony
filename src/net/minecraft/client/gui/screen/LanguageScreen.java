...
public class LanguageScreen extends SettingsScreen
{
    ...
    protected void init()
    {
        ...
        {
            List.LanguageEntry languagescreen$list$languageentry = this.list.getSelected();
    ...
    class List extends ExtendedList<List.LanguageEntry>
    {
        ...
        public class LanguageEntry extends net.minecraft.client.gui.widget.list.AbstractList.AbstractListEntry<LanguageEntry>
        {
