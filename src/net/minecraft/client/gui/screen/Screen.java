...
public abstract class Screen extends FocusableGui implements IScreen, IRenderable, ScreenHooks
{
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        HarmonyChestTrackerBootstrap.fireScreenLateRender(matrixStack, this, mouseX, mouseY, partialTicks);
    }
    ...
    {
        return HarmonyChestTrackerBootstrap.fireScreenKeyReleased(this, keyCode, scanCode, modifiers)
    ...
    public void init(Minecraft minecraft, int width, int height)
    {
        ...
        this.init();
        HarmonyChestTrackerBootstrap.fireScreenInitPost(minecraft, this);
    }

    @Override
    public List<Widget> cloth$getButtonWidgets()
    {
        return this.buttons;
    }

    @Override
    public List<IGuiEventListener> cloth$getChildren()
    {
        return this.children;
    }

    @Override
    public Widget cloth$addButtonWidget(Widget widget)
    {
    ...
    @Override
    public void cloth$setTitle(ITextComponent title)
    {
    }
    ...
    {
        if (this.shouldForceMainScreenBackground())
        {
        ...
        else if (this.shouldUseMainScreenBackground())
        {
            float time = System.currentTimeMillis() / 1000.0f;
            AnimatedBackgroundRenderer.drawMainMenuStyle(this.minecraft, this.width, this.height, 1.0f, time);
        }
    ...
    private boolean shouldForceMainScreenBackground()
    {
        return this instanceof DownloadTerrainScreen;
    }

    private boolean shouldUseMainScreenBackground()
    {
        return this instanceof MultiplayerScreen
                || this instanceof OptionsScreen
                || this instanceof CreateWorldScreen
                || this instanceof ConnectingScreen
                || this instanceof DownloadTerrainScreen;
    }
