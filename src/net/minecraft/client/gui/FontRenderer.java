...
public class FontRenderer
{
    ...
    {
        return this.func_243248_b(matrixStack, text, x, y, color);
    }

    public int drawTextWithShadow(MatrixStack matrixStack, ITextComponent text, float x, float y, int color)
    {
        return this.func_243246_a(matrixStack, text, x, y, color);
    }

    public int drawText(MatrixStack matrixStack, IReorderingProcessor text, float x, float y, int color)
    {
        return this.func_238422_b_(matrixStack, text, x, y, color);
    }

    public int drawTextWithShadow(MatrixStack matrixStack, IReorderingProcessor text, float x, float y, int color)
    {
        return this.func_238407_a_(matrixStack, text, x, y, color);
    }
    ...
    {
        text = StreamerMode.getReplaced(text);
    ...
    public float renderStringAtPos(String text, float x, float y, int color, boolean isShadow, Matrix4f matrix, IRenderTypeBuffer buffer, boolean isTransparent, int colorBackgroundIn, int packedLight)
    {
        CharacterRenderer fontrenderer$characterrenderer = new CharacterRenderer(buffer, x, y, color, isShadow, matrix, isTransparent, packedLight);
    ...
    {
        CharacterRenderer fontrenderer$characterrenderer = new CharacterRenderer(p_238426_7_, p_238426_2_, p_238426_3_, p_238426_4_, p_238426_5_, p_238426_6_, p_238426_8_, p_238426_10_);
    ...
    {
        return MathHelper.ceil(this.field_238402_e_.func_238350_a_(StreamerMode.getReplaced(text)));
    }
    ...
    {
        p_238413_1_ = StreamerMode.getReplaced(p_238413_1_);
    ...
    {
        return this.field_238402_e_.func_238361_b_(StreamerMode.getReplaced(p_238412_1_), p_238412_2_, Style.EMPTY);
    }

    public String trimStringToWidth(String text, int width)
    {
        return this.func_238412_a_(text, width);
    }
    ...
    {
        return 9 * this.field_238402_e_.func_238365_g_(StreamerMode.getReplaced(str), maxLength, Style.EMPTY).size();
    }
