...
public class Framebuffer
{
    ...
    private int framebufferFilterTexture = -1;
    ...
    {
        final int width = Math.max(1, p_216491_1_);
        final int height = Math.max(1, p_216491_2_);
        if (!RenderSystem.isOnRenderThread())
        {
            RenderSystem.recordRenderCall(() ->
            {
                this.resizeRaw(width, height, p_216491_3_);
            });
        }
        else
        {
    ...
    public void deleteFramebuffer()
    {
        if (GLX.isUsingFBOs())
        {
            ...
            if (this.framebufferTexture > -1)
            {
                ...
                this.framebufferTexture = -1;
                this.framebufferFilterTexture = -1;
            }
    ...
    public void setFramebufferFilter(int framebufferFilterIn)
    {
        if (GLX.isUsingFBOs())
        {
            ...
            if (this.framebufferFilter == framebufferFilterIn && this.framebufferFilterTexture == this.framebufferTexture)
            {
                return;
            }

            this.framebufferFilter = framebufferFilterIn;
            this.framebufferFilterTexture = this.framebufferTexture;
            GlStateManager.bindTexture(this.framebufferTexture);
