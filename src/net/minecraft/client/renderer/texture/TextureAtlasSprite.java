...
public class TextureAtlasSprite implements AutoCloseable, IForgeTextureAtlasSprite {
    ...
    private byte moreCullingHasTransparency = -1;
    private byte moreCullingHasTranslucency = -1;

    public TextureAtlasSprite(ResourceLocation p_i242114_1_) {
        this.atlasTexture = null;
        this.spriteInfo = new Info(p_i242114_1_, 0, 0, (AnimationMetadataSection) null);
    ...
    private TextureAtlasSprite(TextureAtlasSprite p_i242115_1_) {
        ...
        Info textureatlassprite$info = p_i242115_1_.spriteInfo;
        ...
        this.spriteInfo = new Info(resourcelocation1, i, j, animationmetadatasection);
        ...
        if (p_i242115_1_.interpolationData != null) {
            this.interpolationData = new InterpolationData(p_i242115_1_.interpolationData.images);
        } else {
            this.interpolationData = null;
        }
    ...
    protected TextureAtlasSprite(AtlasTexture p_i242116_1_, Info p_i242116_2_, int p_i242116_3_, int p_i242116_4_, int p_i242116_5_, int p_i242116_6_, int p_i242116_7_, NativeImage p_i242116_8_, ShadersTextureType p_i242116_9_) {
        ...
        this.spriteInfo = new Info(p_i242116_2_.spriteLocation, i, j, animationmetadatasection);
        ...
        if (animationmetadatasection.isInterpolate()) {
            this.interpolationData = new InterpolationData(p_i242116_2_, p_i242116_3_);
        } else {
            this.interpolationData = null;
        }
    ...
    {
        return this.frames != null && this.frames.length > 0 ? this.frames[0] : null;
    }

    public boolean hasTransparency()
    {
        if (this.moreCullingHasTransparency == -1)
        {
            this.moreCullingHasTransparency = (byte)(SpriteUtils.doesHaveTransparency(this) ? 1 : 0);
        }

        return this.moreCullingHasTransparency == 1;
    }

    public boolean hasTranslucency()
    {
        if (this.moreCullingHasTranslucency == -1)
        {
            this.moreCullingHasTranslucency = (byte)(SpriteUtils.doesHaveTranslucency(this) ? 1 : 0);
        }

        return this.moreCullingHasTranslucency == 1;
    }
    ...
    public TextureAtlasSprite makeSpriteShaders(ShadersTextureType p_makeSpriteShaders_1_, int p_makeSpriteShaders_2_, AnimationMetadataSection p_makeSpriteShaders_3_) {
        ...
        if (this.resourceManager.hasResource(resourcelocation1)) {
            try (IResource iresource = this.resourceManager.getResource(resourcelocation1)) {
                ...
                Info textureatlassprite$info = new Info(resourcelocation, pair.getFirst(), pair.getSecond(), animationmetadatasection);
                ...
                if (nativeimage.getWidth() != this.getWidth()) {
                    ...
                    if (nativeimage1 != nativeimage) {
                        ...
                        textureatlassprite$info = new Info(resourcelocation, (int) ((double) pair.getFirst().intValue() * d0), (int) ((double) pair.getSecond().intValue() * d0), animationmetadatasection);
                    }
                }
        ...
        if (textureatlassprite == null) {
            ...
            Info textureatlassprite$info1 = new Info(resourcelocation, this.getWidth(), this.getHeight(), AnimationMetadataSection.EMPTY);
    ...
    final class InterpolationData implements AutoCloseable {
        ...
        private InterpolationData(Info spriteInfoIn, int mipmapLevelsIn) {
