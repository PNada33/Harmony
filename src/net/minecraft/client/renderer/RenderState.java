...
import xd.harm.modules.impl.render.EnchantmentColor;
...
public abstract class RenderState
{
    ...
    private static void applyEnchantmentColor()
    {
        if (!EnchantmentColor.enabled())
        {
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
            return;
        }
        ...
        RenderSystem.color4f(red, green, blue, alpha <= 0.0F ? 1.0F : alpha);
    }
    ...
    public static class AlphaState extends RenderState
    {
        ...
        public boolean equals(@Nullable Object p_equals_1_)
        {
            ...
            else if (p_equals_1_ != null && this.getClass() == p_equals_1_.getClass())
            {
                ...
                {
                    return this.ref == ((AlphaState)p_equals_1_).ref;
                }
            }
            else
            {
    ...
    public static class LineState extends RenderState
    {
        ...
        public boolean equals(@Nullable Object p_equals_1_)
        {
            ...
            {
                return !super.equals(p_equals_1_) ? false : Objects.equals(this.width, ((LineState)p_equals_1_).width);
            }
            else
            {
                return false;
