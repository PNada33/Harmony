...
public class WeightedBakedModel implements IBakedModel
{
    ...
    {
        this.hasTranslucency = this.baseModel.hasTextureTranslucency(null);

        if (!this.hasTranslucency)
        {
            for (WeightedModel weightedbakedmodel$weightedmodel : this.models)
            {
                if (weightedbakedmodel$weightedmodel.model.hasTextureTranslucency(null))
                {
