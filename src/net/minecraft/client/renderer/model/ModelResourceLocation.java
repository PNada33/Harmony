...
public class ModelResourceLocation extends ResourceLocation
{
    ...
    {
        super(resourceParts);
        this.variant = Deduplicator.deduplicateVariant(resourceParts[2].toLowerCase(Locale.ROOT));
    }
    ...
    public ModelResourceLocation(ResourceLocation location, String variantIn)
    {
        ...
        this.variant = Deduplicator.deduplicateVariant(variantIn.toLowerCase(Locale.ROOT));
    }
