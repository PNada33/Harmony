...
public class BlockModelShapes
{
    ...
    {
        return new ModelResourceLocation(location, getPropertyMapString(state));
    }
    ...
    public static String getPropertyMapString(BlockState state)
    {
        StringBuilder stringbuilder = new StringBuilder();
        ...
        for (Property<?> property : state.getProperties())
        {
            ...
            stringbuilder.append(property.getName());
            stringbuilder.append('=');
            stringbuilder.append(getPropertyValueString(property, state.get(property)));
        }
