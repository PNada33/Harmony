...
public class TileEntityRendererDispatcher
{
    ...
    {
        Vector3d cameraPos = this.renderInfo.getProjectedView();
        double x = (double)tileEntityIn.getPos().getX() + 0.5D - cameraPos.x;
        double y = (double)tileEntityIn.getPos().getY() + 0.5D - cameraPos.y;
        double z = (double)tileEntityIn.getPos().getZ() + 0.5D - cameraPos.z;

        if (x * x + y * y + z * z <= tileEntityIn.getMaxRenderDistanceSquared())
        {
