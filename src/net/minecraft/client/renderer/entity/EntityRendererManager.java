...
public class EntityRendererManager implements IEntityRenderManager {
    ...
    @Setter
    @Getter
    private boolean renderShadow = true, renderName;
    ...
    public <E extends Entity> void renderEntityStaticGlow(E entityIn, double xIn, double yIn, double zIn, float rotationYawIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        if (this.info != null) {
            EntityRenderer<? super E> entityrenderer = this.getRenderer(entityIn);
