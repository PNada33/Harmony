...
import xd.harm.utils.render.VisualityAnimationHelper;
...
public class BipedModel<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead
{
    ...
    public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        VisualityAnimationHelper.applyPlayerVisualityAnimations(this, entityIn, limbSwing, limbSwingAmount, ageInTicks);
