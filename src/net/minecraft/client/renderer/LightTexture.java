...
public class LightTexture implements AutoCloseable
{
    ...
    private final Vector3f skyVector = new Vector3f();
    private final Vector3f lightVector = new Vector3f();
    private final Vector3f whiteVector = new Vector3f(1.0F, 1.0F, 1.0F);
    ...
    public void updateLightmap(float partialTicks)
    {
        if (this.needsUpdate)
        {
            ...
            if (clientworld != null)
            {
                ...
                Vector3f vector3f = this.skyVector;
                vector3f.set(f9, f9, 1.0F);
                vector3f.lerp(this.whiteVector, 0.35F);
                float f3 = this.torchFlicker + 1.5F;
                Vector3f vector3f1 = this.lightVector;
                boolean hasAlternateLight = clientworld.func_239132_a_().func_241684_d_();
                float bossColorModifier = this.entityRenderer.getBossColorModifier(partialTicks);
