...
import xd.harm.events.combat.BreakEvent;
...
public class Block extends AbstractBlock implements IItemProvider {
    ...
    public static boolean shouldSideBeRendered(BlockState adjacentState, IBlockReader blockState, BlockPos blockAccess, Direction pos) {
        ...
        if (adjacentState.isSideInvisible(blockstate, pos)) {
            return false;
        } else if (MoreCullingConfig.useBlockStateCulling) {
            if (adjacentState.usesCustomShouldDrawFace()) {
                Optional<Boolean> optional = adjacentState.customShouldDrawFace(blockState, blockstate, blockAccess, blockpos, pos);
            ...
            if (blockstate.isSolid() || blockstate.getBlock().canCollide && blockstate.getRenderType() != BlockRenderType.INVISIBLE && adjacentState.shouldAttemptToCull() && blockstate.shouldAttemptToCull()) {
                if (blockstate.cantCullAgainst()) {
                    return true;
                }
    ...
    {
        return !CullingUtils.hasModelTranslucency(state);
    }
    ...
    public void onPlayerDestroy(IWorld worldIn, BlockPos pos, BlockState state) {
        Harmony.getInstance().getEventBus().post(new BreakEvent());
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        if (state.getBlock() == Blocks.OBSIDIAN) {
            ...
            Harmony.getInstance().getEventBus().post(placeObsidianEvent);
        }
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        HarmonyChestTrackerBootstrap.handleBlockBreak(worldIn, pos);
