...
public class Chunk implements IChunk, ExtendedChunk
{
    ...
    public Chunk(World worldIn, ChunkPrimer primer)
    {
        ...
        this.blockNibbles = ((ExtendedChunk)primer).getBlockNibbles();
        this.skyNibbles = ((ExtendedChunk)primer).getSkyNibbles();
        this.skyEmptinessMap = ((ExtendedChunk)primer).getSkyEmptinessMap();
        this.blockEmptinessMap = ((ExtendedChunk)primer).getBlockEmptinessMap();
        this.dirty = true;
    }
    ...
    public BlockState setBlockState(BlockPos pos, BlockState state, boolean isMoving)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    TileEntity tileentity = this.getTileEntity(pos, CreateEntityType.CHECK);
