...
public class ServerWorld extends World implements ISeedReader, ExtendedWorld
{
    ...
    @Override
    public Chunk getChunkAtImmediately(int chunkX, int chunkZ)
    {
        return this.getChunkProvider().getChunkNow(chunkX, chunkZ);
    }

    @Override
    public IChunk getAnyChunkImmediately(int chunkX, int chunkZ)
    {
        ChunkHolder chunkholder = this.getChunkProvider().chunkManager.func_219219_b(ChunkPos.asLong(chunkX, chunkZ));
        return chunkholder == null ? null : chunkholder.func_219287_e();
    }
    ...
    @Override
    public void setCustomLightHandler(VariableBlockLightHandler handler)
    {
