...
public class BrewingStandContainer extends Container
{
    ...
    {
        return this.inventorySlots.get(3).getStack();
    }

    public ItemStack getFuelStack()
    {
        return this.inventorySlots.get(4).getStack();
    }

    public ItemStack getPotionStack(int slot)
    {
        if (slot >= 0 && slot <= 2)
        {
            return this.inventorySlots.get(slot).getStack();
        }
        return ItemStack.EMPTY;
    }

    public boolean hasEmptyPotionSlot()
    {
        for (int i = 0; i < 3; i++)
        {
    ...
    public boolean hasEmptyIngredientSlot()
    {
        return this.inventorySlots.get(3).getStack().isEmpty();
    }

    public boolean hasEmptyFuelSlot()
    {
        return this.inventorySlots.get(4).getStack().isEmpty();
    }

    public IInventory getBrewingInventory()
    {
