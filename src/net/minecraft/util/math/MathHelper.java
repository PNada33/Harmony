...
public class MathHelper
{
    ...
    {
        return fastMath ? SIN_TABLE_FAST[(int)(d * radToIndex) & 4095] : SIN_TABLE[(int)(d * 10430.378F) & 65535];
    }
    ...
    {
        return fastMath ? SIN_TABLE_FAST[(int)(d * radToIndex + 1024.0F) & 4095] : SIN_TABLE[(int)(d * 10430.378F + 16384.0F) & 65535];
    }
