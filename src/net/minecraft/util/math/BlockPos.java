...
public class BlockPos extends Vector3i
{
    ...
    public Vector3d getVec() {
        return new Vector3d((double)this.getX(), (double)this.getY(), (double)this.getZ());
    }
    ...
    public static Iterable<Mutable> func_243514_a(BlockPos p_243514_0_, int p_243514_1_, Direction p_243514_2_, Direction p_243514_3_)
    {
        ...
        return () ->
        {
            return new AbstractIterator<Mutable>()
            {
                ...
                private final Mutable field_243521_f = p_243514_0_.toMutable().move(p_243514_3_);
