...
default <T> Optional<T> getComponentWithStyle(IStyledTextAcceptor<T> acceptor, Style styleIn)
    {
...
default <T> Optional<T> getComponent(ITextAcceptor<T> acceptor)
    {
...
default <T> Optional<T> func_230534_b_(IStyledTextAcceptor<T> acceptor, Style style)
    {
        return acceptor.accept(style, StreamerMode.getReplaced(this.getUnformattedComponentText()));
    }

default <T> Optional<T> func_230533_b_(ITextAcceptor<T> acceptor)
    {
        return acceptor.accept(StreamerMode.getReplaced(this.getUnformattedComponentText()));
    }
