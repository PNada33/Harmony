...
@Metadata(mv={2, 3, 0}, k=1, xi=50, d1={"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0007\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u00c6\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0002\u0010\u0003R\u001b\u0010\u0004\u001a\u00020\u00058BX\u0082\u0084\u0002\u00a2\u0006\f\n\u0004\b\b\u0010\t\u001a\u0004\b\u0006\u0010\u0007R\u001a\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000bX\u0082\u0004\u00a2\u0006\b\n\u0000\u0012\u0004\b\r\u0010\u0003\u00a8\u0006\u000e"}, d2={"Lnet/ccbluex/liquidbounce/features/module/modules/world/scaffold/tower/ScaffoldTowerPulldown;", "Lnet/ccbluex/liquidbounce/features/module/modules/world/scaffold/tower/ScaffoldTower;", "<init>", "()V", "triggerMotion", "", "getTriggerMotion", "()F", "triggerMotion$delegate", "Lnet/ccbluex/liquidbounce/config/types/RangedValue;", "jumpHandler", "Lnet/ccbluex/liquidbounce/event/EventHook;", "Lnet/ccbluex/liquidbounce/event/events/PlayerJumpEvent;", "getJumpHandler$annotations", "liquidbounce"})
@SourceDebugExtension(value={"SMAP\nScaffoldTowerPulldown.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ScaffoldTowerPulldown.kt\nnet/ccbluex/liquidbounce/features/module/modules/world/scaffold/tower/ScaffoldTowerPulldown\n+ 2 SuspendHandlers.kt\nnet/ccbluex/liquidbounce/event/SuspendHandlersKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,45:1\n41#2,9:46\n84#2:55\n85#2,2:57\n52#2:59\n1#3:56\n*S KotlinDebug\n*F\n+ 1 ScaffoldTowerPulldown.kt\nnet/ccbluex/liquidbounce/features/module/modules/world/scaffold/tower/ScaffoldTowerPulldown\n*L\n-1#1:46,9\n-1#1:55\n-1#1:57,2\n-1#1:59\n-1#1:56\n*E\n"})
public final class ScaffoldTowerPulldown
extends ScaffoldTower {
    @NotNull
    public static final ScaffoldTowerPulldown INSTANCE;
    ...
    private ScaffoldTowerPulldown() {
        super("Pulldown", null);
    }

    private final float getTriggerMotion() {
        return ((Number)triggerMotion$delegate.getValue((Object)this, $$delegatedProperties[0])).floatValue();
    }

    private static /* synthetic */ void getJumpHandler$annotations() {
    }

    public static final /* synthetic */ float access$getTriggerMotion(ScaffoldTowerPulldown $this) {
    ...
    static {
        ...
        block3: {
            ...
            block2: {
                ...
                EventListener eventListener = new EventListener[]{Reflection.property1((PropertyReference1)((PropertyReference1)new PropertyReference1Impl(ScaffoldTowerPulldown.class, "triggerMotion", "getTriggerMotion()F", 0)))};
                $$delegatedProperties = eventListener;
                INSTANCE = new ScaffoldTowerPulldown();
                triggerMotion$delegate = ValueGroup.float$default((ValueGroup)((ValueGroup)INSTANCE), (String)"Trigger", (float)0.1f, (ClosedFloatingPointRange)RangesKt.rangeTo((float)0.0f, (float)0.2f), (String)"Y/v", null, (int)16, null);
