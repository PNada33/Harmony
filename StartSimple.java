...
/**
 * Упрощенный запуск для тестирования исправлений Harmony мода
 * без зависимости от Minecraft Main класса
 */
public class StartSimple {
    
    public static void main(String[] args) {
        System.out.println("=== Harmony Figura Cosmetic - Запуск теста ===\n");
